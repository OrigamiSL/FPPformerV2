...
class TokenEmbedding(nn.Module):
    def __init__(self, d_model, start_pos=0):
        ...
        if start_pos == 0:
            ...
            self.tokenConv = nn.Conv2d(in_channels=1, out_channels=d_model, kernel_size=1, padding=0, bias=False)
...
class DataEmbedding(nn.Module):
    def __init__(self, d_model, start_pos=0):
        ...
        self.value_embedding = TokenEmbedding(d_model=d_model, start_pos=start_pos)
